...
namespace EDSDK
{
    ...
    public class SDKHandler : IDisposable
    {
        ...
        /// The used camera
        /// </summary>
        public CanonCamera MainCamera { get; private set; }
        /// <summary>
        ...
        public List<CanonCamera> GetCameraList()
        {
            IntPtr camlist;
            //get list of cameras
            ...
            List<CanonCamera> OutCamList = new List<CanonCamera>();
            for (int i = 0; i < c; i++)
            {
                IntPtr cptr;
                //get pointer to camera at index i
                Error = EdsGetChildAtIndex(camlist, i, out cptr);
                OutCamList.Add(new CanonCamera(cptr));
            }
            return OutCamList;
        }
        ...
        public void OpenSession(CanonCamera newCamera)
        {
